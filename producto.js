const productmodel=require("C:\Users\BEMA\Desktop\node_modules\STORE\src\models\productomodel.js");
...
const addproduct=async(req, res)=>{
    ...
    try{
            ...
            if(req.body.tsofertahasta.includes("l")){
                req.body.tsofertahasta= req.body.tsofertahasta.replace("l","").replace("000y","");
